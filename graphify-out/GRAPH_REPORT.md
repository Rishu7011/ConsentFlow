...
Cohesion: 0.05
Nodes (65): AuditLogEntry, AuditTrailResponse, ConsentRevokeRequest, ConsentStatusResponse, ConsentUpsertRequest, ExtensionAnonymizePlaceholderRequest, HealthResponse, PolicyFinding (+57 more)
...
Cohesion: 0.09
Nodes (32): check_redis(), close_redis_client(), _consent_key(), create_redis_client(), get_consent_cache(), invalidate_consent_cache(), cache.py — Redis helpers for consent lookup caching.  Key schema:  consent:{us, Delete the cached consent entry for user+purpose. (+24 more)
...
Cohesion: 0.1
Nodes (21): anonymize_record(), _anonymize_text(), _anonymize_value(), consentflow/anonymizer.py — Full Presidio PII detection + anonymisation.  Plan, Return a copy of *record* with all string-valued PII fields masked.      Non-s, Return a copy of *record* with all string-valued PII fields masked.      Non-s, Recursively anonymize a value (dict, list, str, or other)., Recursively anonymize a value (dict, list, str, or other). (+13 more)
