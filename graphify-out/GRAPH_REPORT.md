# Graph Report - ConsentFlow  (2026-05-09)

## Corpus Check
- 123 files · ~70,533 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 860 nodes · 1314 edges · 53 communities detected
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 146 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1d2ce558`
...
Cohesion: 0.08
Nodes (26): attachHistoryMasker(), maskTextInUserBubble(), attachAndBind(), ensureStatusPill(), loadConsentProfile(), main(), setStatusPill(), startStatusPillWatchdog() (+18 more)
...
Cohesion: 0.1
Nodes (24): analyzer(), anonymize_record(), _anonymize_text(), _anonymize_value(), anonymizer(), _build_registry(), get_analyzer(), get_anonymizer() (+16 more)
...
Cohesion: 0.12
Nodes (15): ConsentRevokeRequest, ConsentStatusResponse, ConsentUpsertRequest, ExtensionAnonymizePlaceholderRequest, HealthResponse, PolicyScanListItem, Lightweight row returned from GET /policy-auditor/scans (list view)., Payload for POST /consent — grant or revoke a consent record. (+7 more)

### Community 20 - "Community 20"
Cohesion: 0.18
Nodes (11): filtered_count(), GateResult, consentflow/dataset_gate.py — Consent-aware dataset registration gate.  Public, Summary of a single dataset registration run., Iterate over *dataset*, enforce consent, anonymize revoked records, and     log, register_dataset_with_consent_check(), _make_consent_lookup(), tests/test_step3.py — Integration test for Step 3 (Dataset Gate).  Scenario - (+3 more)
...
Cohesion: 0.17
Nodes (14): anonymize(), consent_profile(), _cors(), _generate_dummy(), options_handler(), extension.py — FastAPI router for the ConsentFlow Privacy Shield browser extensi, Handle pre-flight CORS requests from the browser extension., Handle pre-flight CORS requests from the browser extension. (+6 more)
...
## Knowledge Gaps
- **234 isolated node(s):** `_LazyModule`, `consentflow/anonymizer.py — Full Presidio PII detection + anonymisation.  Plan 1`, `Return the AnalyzerEngine singleton, creating it on first call.`, `Return the AnonymizerEngine singleton, creating it on first call.`, `Descriptor that returns the lazy singleton when accessed.` (+229 more)
...
- **Why does `str` connect `Community 0` to `Community 3`, `Community 4`, `Community 5`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 28`?**
  _High betweenness centrality (0.338) - this node is a cross-community bridge._
- **Why does `chat_message()` connect `Community 16` to `Community 4`, `Community 7`?**
  _High betweenness centrality (0.149) - this node is a cross-community bridge._
- **Why does `FakeRedis` connect `Community 11` to `Community 7`?**
...
- **What connects `_LazyModule`, `consentflow/anonymizer.py — Full Presidio PII detection + anonymisation.  Plan 1`, `Return the AnalyzerEngine singleton, creating it on first call.` to the rest of the system?**
